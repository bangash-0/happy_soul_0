        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                _isDark ? Colors.black : kButtonColor.withOpacity(.2),
                kSecondaryColor
              ],
            ),
          ),
              ...
              children: [
                ...
                Row(
                  children: [
                    const Spacer(),
                    IconButton(
                      highlightColor: kTextColor.withOpacity(.5),
                      onPressed: () {
                    ...
                    IconButton(
                      highlightColor: kTextColor.withOpacity(.2),
                      onPressed: () async {
                ...
                ValueListenableBuilder(
                  ...
                  builder: (context, value, _) {
                    return Slider(
                      thumbColor: kTextColor.withOpacity(.8),
                      activeColor: kTextColor.withOpacity(.8),
                      inactiveColor: kTextColor.withOpacity(.4),
                      secondaryActiveColor: kTextColor.withOpacity(.4),
