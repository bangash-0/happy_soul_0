...
const kPrimaryColor = Color(0xFFAC87C5);
const kSecondaryColor = Color(0xFF4D027C);
const kFontColor = Color(0xFF7469B6);
const kButtonColor = Color(0xFFAD88C6);
const kTextColor = Color(0xFFFFE6E6);

const kSendButtonTextStyle = TextStyle(
  color: Color(0xDB7505FF),
...
const OPENAI_API_KEY = "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";
